...
export default async function handler(req, res) {
  ...
  if (req.method === 'POST') {
    const { title, description, featured_image, category, reporter_name, cretaed_by, published_by, last_modified_by, publish_status, tags, meta_title, meta_description, meta_image, focus_keyword } = req.body;
